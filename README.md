...
- [x] 상세 페이지에서 첨부된 oas.yaml 파일의 /api/v1/products/{productId}/detail, /api/v1/products/{productId}/options를 참고하여 API를 구현
- [x] 없는 상품의 경우 메인 페이지로 연결
- [x] 나에게 선물하기 버튼 클릭 시, 로그인 되어 있지 않다면 로그인 페이지로 이동
- [x] OrderPage에서 결제하기 버튼 클릭 시, 선물 메시지가 비어 있다면 입력하도록 alert 구현
